 ...
 *                 message:
 *                   type: string
 *                   example: Invalid email or password. 2 attempts remaining.
 *       423:
 ...
 *                 message:
 *                   type: string
 *                   example: Your account has been locked due to multiple failed login attempts. Please wait 15 minutes or reset your password.
 */
 ...
 *     description: Update the current user's profile information (name and/or email)
 *     tags: [Profile]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Change the current user's password by providing the current password and new password
 *     tags: [Profile]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *                 message:
 *                   type: string
 *                   example: The current password you provided is incorrect
 */
router.put('/change-password', authenticateToken, validatePasswordChange, handleValidationErrors, authController.changePassword);
